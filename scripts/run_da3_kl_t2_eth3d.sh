...
# KL+Cos with T=2.0 only (no L2 norm, no RKD) on eth3d
...
OUTPUT_DIR=./checkpoints/da3_kl_t2_eth3d/eth3d
BENCHMARK_ROOT=./workspace/da3_kl_t2_eth3d

echo "============================================================"
echo "Training eth3d — KL+Cos with T=2.0 (no L2 norm, no RKD)"
echo "============================================================"
