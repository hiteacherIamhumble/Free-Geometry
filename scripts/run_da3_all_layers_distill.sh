...
# =============================================================================
# DA3 Giant: All-Layer Feature Distill — Train + Benchmark all datasets
#
# Datasets: scannetpp, eth3d, 7scenes, hiroom
# Loss: feature (KL+cos on all 4 backbone layers [19,27,33,39] + RKD), output_weight=0
#
# Usage:
...
OUTPUT_DIR=./checkpoints/da3_all_layers_distill
BENCHMARK_ROOT=./workspace/da3_all_layers_distill
...
train_single_dataset() {
    ...
    echo ""
    echo "============================================================"
    echo "Training DA3 on ${DATASET} — ALL-LAYER DISTILL (no output loss)"
    echo "  Samples/scene: ${SAMPLES}, Seeds: ${SEEDS}, Epochs: ${DS_EPOCHS}"
    echo "  Loss: feature (KL+cos on all 4 layers + RKD), output_weight=0"
    echo "============================================================"
