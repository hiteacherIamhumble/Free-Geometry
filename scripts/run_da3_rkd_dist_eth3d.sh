...
OUTPUT_DIR=./checkpoints/da3_rkd_dist_eth3d/eth3d
BENCHMARK_ROOT=./workspace/da3_rkd_dist_eth3d

# Train eth3d with rkd distance loss added
echo "============================================================"
echo "Training eth3d — rkd distance loss test"
echo "============================================================"
...
# Benchmark all saved epochs at 4v and 8v
echo ""
echo "============================================================"
