...
# =============================================================================
# VGGT Experiment V12: Cross-Frame RKD on ScanNet++ (15 samples/scene)
# =============================================================================
#
# This experiment:
# - Trains on scannetpp only
# - Loss: all-token softmax KL + cosine + cross-frame RKD (same as V10/V11)
# - 15 samples/scene, seeds 30-44
#
# Training config:
#   scannetpp: 15 samples/scene, seeds 30 31 32 ... 44
#
# Usage:
#   ./scripts/run_vggt_experiment_v12.sh [train|benchmark_lora|all]
#
# =============================================================================

# === Configuration ===
MODEL_NAME=facebook/vggt-1b
OUTPUT_DIR=./checkpoints/vggt_experiment_v12
BENCHMARK_ROOT=./workspace/vggt_experiment_v12
...
run_training() {
    echo ""
    echo "============================================================"
    echo "Training: scannetpp (15 samples/scene)"
    echo "============================================================"
...
usage() {
    ...
    echo "  scannetpp: 15 samples/scene, seeds 30-44"
    echo ""
}
...
echo ""
echo "============================================================"
echo "=== VGGT Experiment V12 Complete ==="
echo "============================================================"
echo ""
echo "Experiment: KL + cosine + RKD on scannetpp (15 samples/scene)"
