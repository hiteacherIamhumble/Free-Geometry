...
OUTPUT_DIR=./checkpoints/da3_rkd_only/scannetpp
BENCHMARK_ROOT=./workspace/da3_rkd_only

# Train: RKD only (kl=0, cos=0, output=0)
python -u ./scripts/train_distill.py \
    ...
    --all_token_softmax_kl_weight 0.0 \
    --all_token_softmax_cos_weight 0.0 \
    --rkd_weight 2.0 \
    --rkd_num_triplets 4096 \
