...
# =============================================================================
# VGGT Experiment V16: Fixed-Subset Training with 16v Teacher / 8v Student
# =============================================================================
#
# Same as V15 but with 16v teacher -> 8v student distillation (V15 used 8v->4v)
...
# - Loss: KL + cosine + cross-frame RKD (same as V14/V15)
# - LoRA benchmark only: 4v, 8v, maxframe with seed 43
#
# Training configs (per-dataset):
#   scannetpp: 10 samples/scene, seeds 30-39, 1 epoch
#   7scenes:   20 samples/scene, seeds 30-49, 1 epoch
#
# Usage:
#   ./scripts/run_vggt_experiment_v16.sh [train|benchmark_lora|all]
#   ./scripts/run_vggt_experiment_v16.sh train_scannetpp
#   ./scripts/run_vggt_experiment_v16.sh train_7scenes
#
# =============================================================================

# === Configuration ===
MODEL_NAME=facebook/vggt-1b
OUTPUT_DIR=./checkpoints/vggt_experiment_v16
BENCHMARK_ROOT=./workspace/vggt_experiment_v16
...
train_single_dataset() {
    ...
    echo "  Teacher views: ${NUM_VIEWS}, Student views: $((NUM_VIEWS / 2))"
...
run_training() {
    ...
    echo "  Teacher: ${NUM_VIEWS}v, Student: $((NUM_VIEWS / 2))v"
    echo "  Fixed subset: seed=${FIXED_SUBSET_SEED}, max_frames=${FIXED_SUBSET_MAX_FRAMES}"
    echo "============================================================"
...
usage() {
    ...
    echo "  scannetpp: 10 samples/scene, seeds 30-39, 1 epoch"
    echo "  7scenes:   20 samples/scene, seeds 30-49, 1 epoch"
    echo ""
}
...
echo ""
echo "============================================================"
echo "=== VGGT Experiment V16 Complete ==="
echo "============================================================"
echo ""
echo "Experiment: Fixed-subset training (16v->8v) on ScanNet++ and 7Scenes"
echo "  Fixed subset: seed=${FIXED_SUBSET_SEED}, max_frames=${FIXED_SUBSET_MAX_FRAMES}"
