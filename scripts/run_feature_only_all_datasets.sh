...
# =============================================================================
# Feature-Only Loss on All 4 Datasets (no output loss)
# =============================================================================
#
# Feature loss (V14): KL + cosine + cross-frame RKD
# Output loss: DISABLED (output_weight=0)
# AMP enabled, maxframe=50
#
# Usage:
#   ./scripts/run_feature_only_all_datasets.sh [command]
#
# Commands:
...
train_single_dataset() {
    ...
    echo ""
    echo "============================================================"
    echo "Training on ${DATASET} (AMP) — FEATURE ONLY (no output loss)"
...
run_training() {
    echo ""
    echo "============================================================"
    echo "Training all 4 datasets (FEATURE ONLY): ${ALL_DATASETS}"
    echo "============================================================"
...
run_lora_benchmark() {
    echo ""
    echo "============================================================"
    echo "Benchmarking LoRA models (feature-only)"
...
echo ""
echo "============================================================"
echo "=== Feature-Only All Datasets Experiment Complete ==="
echo "============================================================"
echo ""
