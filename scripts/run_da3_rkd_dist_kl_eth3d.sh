...
# RKD Distance KL loss test on eth3d
# Same as strong_lora eth3d but with --use_rkd_distance (now using KL on diff profiles)
...
OUTPUT_DIR=./checkpoints/da3_rkd_dist_kl_eth3d/eth3d
BENCHMARK_ROOT=./workspace/da3_rkd_dist_kl_eth3d

echo "============================================================"
echo "Training eth3d — rkd distance KL loss test"
echo "============================================================"
