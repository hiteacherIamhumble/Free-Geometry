...
# =============================================================================
# DA3 Giant: Train + Benchmark all datasets (max-frame setting)
#
# Datasets: scannetpp, eth3d, 7scenes, hiroom
# Loss: feature (KL+cos+RKD) + output (cam+depth)
#
# Usage:
#   ./scripts/run_da3_all_datasets.sh [command]
#
# Commands:
...
OUTPUT_DIR=./checkpoints/da3_combined_all
BENCHMARK_ROOT=./workspace/da3_combined_all
...
train_single_dataset() {
    ...
    echo ""
    echo "============================================================"
    echo "Training DA3 on ${DATASET} (combined loss)"
    echo "  Samples/scene: ${SAMPLES}, Seeds: ${SEEDS}, Epochs: ${DS_EPOCHS}"
    echo "  Loss: feature (KL+cos+RKD) + output (cam+depth)"
    echo "============================================================"

    # scannetpp needs --use_scannetpp_test_split to use benchmark dataset format
    local EXTRA_ARGS=""
...
run_training() {
    echo ""
    echo "============================================================"
    echo "Training all datasets: ${ALL_DATASETS}"
    echo "============================================================"
