"""
Dataset for VGGT Knowledge Distillation.

This module provides a dataset loader that can load data from benchmark datasets
for VGGT distillation training. Images are returned in [0, 1] range since
...
class VGGTDistillDataset(Dataset):
    """
    Dataset for VGGT knowledge distillation.
...
def create_vggt_dataloader(
    ...
    **dataset_kwargs,
    ...
    """
    Create a DataLoader for VGGT distillation dataset.

    Args:
        dataset_name: Name of benchmark dataset
        batch_size: Batch size
        num_workers: Number of data loading workers
        **dataset_kwargs: Additional arguments for VGGTDistillDataset
