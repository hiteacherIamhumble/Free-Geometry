"""
ScanNet++ dataset for DA3 Free-Geometry training.

This module provides a PyTorch Dataset for loading ScanNet++ scenes
for Free-Geometry training. Each sample returns:
...
class ScanNetPPFreeGeometryDataset(Dataset):
    """
    ScanNet++ dataset for Free-Geometry.
...
def create_dataloader(
    ...
    **dataset_kwargs,
    ...
    """
    Create a DataLoader for the ScanNet++ Free-Geometry dataset.
    ...
    Args:
        ...
        **dataset_kwargs: Additional arguments for ScanNetPPFreeGeometryDataset

    Returns:
        DataLoader instance
    """
    dataset = ScanNetPPFreeGeometryDataset(
        data_root=data_root,
        split=split,
        **dataset_kwargs,
    )
