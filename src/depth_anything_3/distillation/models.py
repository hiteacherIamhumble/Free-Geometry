"""
Teacher and Student Model Wrappers for Knowledge Distillation.
...
- DistillationOutput: Container for extracted features
...
class DistillationOutput:
    """
    Container for distillation outputs.
...
class TeacherModel(nn.Module):
    ...
    # Default output layers for DA3-Giant (layers 33 and 39 for distillation)
    ...
    def forward(
        ...
        Returns:
            DistillationOutput with layer features and camera tokens
        """
...
class StudentModel(nn.Module):
    """
    Student model for knowledge distillation using HuggingFace PEFT.
...
def create_teacher_student_pair(
    ...
    """
    Create a teacher-student pair for distillation.
