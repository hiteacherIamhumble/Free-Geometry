"""
Training Configuration for DA3 Knowledge Distillation.

This module provides a dataclass-based configuration for distillation training,
...
class DistillConfig:
    ...
    @classmethod
    def from_dict(cls, config_dict: dict) -> "DistillConfig":
...
def get_default_config() -> DistillConfig:
    """Get default distillation configuration."""
    return DistillConfig()


def get_debug_config() -> DistillConfig:
